...
{
    public abstract class PgSqlGenericRepository<TEntity, TId> : IGenericRepository<TEntity, TId> where TEntity : Entity<TId>
    {
        protected string TableName;
        protected readonly IDbConnection DbConnection;
        private protected PgSqlGenericRepository(IDbConnection dbConnection)
        {
