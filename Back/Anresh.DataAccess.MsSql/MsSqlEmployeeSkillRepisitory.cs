...
{
    public class MsSqlEmployeeSkillRepisitory : MsSqlGenericRepository<EmployeeSkill, int>, IEmployeeSkillRepisitory
    {
        public MsSqlEmployeeSkillRepisitory(IDbConnection db) : base(db)
        {
        }
