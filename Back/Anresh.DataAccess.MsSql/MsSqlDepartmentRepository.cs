...
{
    public class MsSqlDepartmentRepository : MsSqlGenericRepository<Department, int>, IDepartmentRepository
    {
        public MsSqlDepartmentRepository(IDbConnection dbConnection) : base(dbConnection)
        {
        }
